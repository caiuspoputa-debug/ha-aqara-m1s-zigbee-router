> **v0.20.3:** group correction uses only a whole-cohort receiver resync. Adaptive/per-hub sync remains disabled. Use service `aqara_m1s_zigbee_router.resync_media_group` to realign all group receivers without restarting FFmpeg/source.
